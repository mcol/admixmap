/*
  ...
  also requires data directory (Eur, Afr or Asian).
...
void PrintHelpText(){
    cout << "----------------------------------------------------------------------------\n" 
	 << "This program converts phased HapMap data to ADMIXMAP format"
	 << "Usage: convertdata -c<chrm> [-p<pop>] [-g<genotypesfile>]"
