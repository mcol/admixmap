###############################################################################################
# makefile for compiling libinterface, the interfaces library
#
...
objects		= IChromosome.o ICompositeLocus.o IFreqArray.o IGenome.o IHapMixFreqs.o IInputData.o IOptions.o

# rand.o AdaptiveRejection.o StepSizeTuner.o Gaussian.o GaussianProposalMH.o DirichletParamSampler.o HamiltonianMonteCarlo.o MuSampler.o DispersionSampler.o ModeFinder.o
...
libinterface: $(objects) 
	ar crs libinterface.a $(objects)
	ranlib libinterface.a

shared: paraheader $(objects)
	$(CXX) $(CPPFLAGS) -shared -Wl,-soname,libinterface.so\
-o libinterface.so $(objects) -lgsl -lgslcblas
...
# dist:
# 	rm libinterface.tar.gz
# 	mkdir libinterface
# 	cp *.cc *.h *.txt README libinterface
# 	cp makefile libinterface
# 	tar -czf libinterface.tar.gz libinterface
# 	rm -R libinterface
